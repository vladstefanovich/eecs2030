...
public class LinkedIntList {
	...
	public void add(int index, int elem) {
		if (index < 0 || index > size) {
			...
			if (index == 0) {
				...
				Node toAdd = new Node(elem, nodeBefore.getNext());
				nodeBefore.setNext(toAdd);
				size++;
			}
	...
	public int remove(int index) {
		...
		int toRemove = getNode(index).getData();
